...
async function test() {
  ...
  // Using text model
  const url = `https://us-central1-aiplatform.googleapis.com/v1/projects/gerador-de-imagens-ia-502303/locations/us-central1/publishers/google/models/gemini-2.0-flash:generateContent`;
  try {
