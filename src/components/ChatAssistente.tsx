...
13. REGRA ABSOLUTA DE EDIÇÃO, ALTERAÇÃO E REMOÇÃO DE ELEMENTOS (SOMBRAS DE FLASH, OBJETOS, MESAS):
    ...
    - Se o usuário pedir para POSICIONAR OU COLOCAR A LOGO (ex: "use minha logo", "coloque essa logo", "substitua a logo"):
      * Defina "useLogo": true, "logoInclusionType": "embedded" (a logo deve ser gerada JUNTO com a arte, substituindo a logo antiga da referência EXATAMENTE NO MESMO LOCAL ESPACIAL da referência original, seja no rodapé inferior esquerdo/direito ou no topo).
      * Preencha em "promptTipografia": "Posicionar o logotipo oficial da marca exatamente no mesmo local onde a logo da referência está localizada (se a logo da referência está no rodapé inferior esquerdo, colocar no rodapé inferior esquerdo; se estiver no topo, colocar no topo). REGRA CRÍTICA: O logotipo JAMAIS deve ficar em cima do cabelo, cabeça, rosto ou corpo do sujeito!"
    - Se o usuário pedir formato para Instagram retrato / post retrato / 4:5:
      * Defina "dimensao": "3:4".
    - Se o usuário pedir para TROCAR A PESSOA / MODELO (ex: "mude a mulher", "use outra mulher", "troque o modelo"):
      * Preencha em "poseDescription": "Nova mulher/modelo profissional com características solicitadas (etnia, corte de cabelo moderno, blazer corporativo refinado em Azul Marinho #102a43 com detalhes dourados #d1aa3a alinhados à paleta de cores), segurando smartphone na mão direita, postura reflexiva e elegante posicionada no canto inferior direito."
      * Preencha em "additionalPrompt": "SUBSTITUIÇÃO DE CASTING / NOVA MODELO: Gerar uma nova mulher com postura corporativa elegante e visual hiper-realista (lente 85mm f/1.8, iluminação de estúdio comercial), segurando o celular e olhando pensativa, posicionada no canto inferior direito da composição."
...
14. REGRA ABSOLUTA DE PRESERVAÇÃO OU TROCA DE ROSTOS, EXPRESSÕES E POSES:
    - Se o usuário NÃO pediu para trocar o modelo:
    ...
    - Se o usuário PEDIU para trocar o modelo (ex: "mude a mulher", "troque por outra pessoa"):
      * Crie uma nova modelo humana hiper-realista com as características solicitadas (etnia, cabelo, figurino corporativo com as cores da paleta), preservando o enquadramento no canto inferior direito e a pose com celular.
