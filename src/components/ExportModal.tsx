...
export const ExportModal: React.FC<ExportModalProps> = ({ 
  ...
  return (
    <div className="absolute top-16 right-6 w-72 bg-black border border-zinc-800 rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden font-sans animate-in fade-in zoom-in-95 duration-200">
      ...
      <div className="p-4 space-y-4">
          ...
          {[
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 p-3 rounded-xl border transition-all ${
                ...
                : 'bg-black border-zinc-800 text-zinc-300 hover:border-zinc-700 hover:bg-[#111]'
              }`}
            >
        ...
        <div className="pt-2">
          ...
          <div className="flex items-center justify-between bg-black border border-zinc-800 rounded-xl p-1">
            <button 
              onClick={() => setZoomPercent(Math.max(10, zoomPercent - 10))}
              className="w-8 h-8 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-[#111] rounded-lg transition-colors"
            >
              <ZoomOut size={14} />
            </button>
        ...
        <button className="w-full flex items-center justify-center gap-2 p-3 mt-2 rounded-xl bg-black hover:bg-[#111] border border-zinc-800 text-zinc-300 text-xs font-bold transition-all group">
