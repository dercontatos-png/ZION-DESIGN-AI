...
export const InpaintCanvas: React.FC<InpaintCanvasProps> = ({
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full">
      <div ref={containerRef} className="relative select-none border border-white/10 rounded-xl overflow-hidden bg-zinc-950 flex items-center justify-center max-w-full">
        <img
          ref={imageRef}
          src={imageUrl}
